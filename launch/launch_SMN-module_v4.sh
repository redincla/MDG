...
{	
  "CarrierScreeningSampleCN.input_bams_samples": [ cat $sample_bams ],
  "CarrierScreeningSampleCN.input_bams_PON": [ cat $PON_bams ],
  "CarrierScreeningSampleCN.sample_list": [ cat $sample_IDs ],
  "CarrierScreeningSampleCN.PON_list": [ cat $PON_IDs ],
  "CarrierScreeningSampleCN.SNP_list": "$3",
  "CarrierScreeningSampleCN.output_file_basename_PON": "PON",
  "CarrierScreeningSampleCN.SMN_CNplot_Rscript": "/mnt/raw-data/scripts/wdls/tasks/SMN-CN-Kmeans_v3.R",
  "CarrierScreeningSampleCN.MedianDepthPON_Rscript": "/mnt/raw-data/scripts/wdls/tasks/MedianDepthPON_v2.R",
  "CarrierScreeningSampleCN.output_file_basename_samples": "${cohort_name}"
}
EOF
...
java -Dconfig.file=/home/credin/.cromwell_config.file -jar /mnt/raw-data/tools/cromwell/cromwell-86.jar run /mnt/raw-data/scripts/wdls/workflows/SMN-modules_v5.wdl -i ${WRKDIR}/json/${cohort_name}.SMNCNcalling.input.json -o ${WRKDIR}/json/${cohort_name}.SMNCNcalling.options.json
