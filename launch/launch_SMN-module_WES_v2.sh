...
if [ $# -eq 4 ]; then
 ...
 WRKDIR=$4 #full directory of processed results to be dropped
	...
	echo "SNP_list: bedfile of SNPs to use for module"
...
{	
  ...
  "SMNSampleCN.SMN_CNplot_Rscript": "/mnt/raw-data/scripts/wdls/tasks/SMN-CN-Kmeans_WES.R",
  "SMNSampleCN.MedianSMNRatios_Rscript": "/mnt/raw-data/scripts/wdls/tasks/MedianSMNRatios.R",
...
java -Dconfig.file=/home/credin/.cromwell_config.file -jar /mnt/raw-data/tools/cromwell/cromwell-86.jar run /mnt/raw-data/scripts/wdls/workflows/SMN-modules_WES_v2.wdl -i ${WRKDIR}/json/${cohort_name}.SMNCNcalling.input.json -o ${WRKDIR}/json/${cohort_name}.SMNCNcalling.options.json
