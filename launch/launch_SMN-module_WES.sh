...
{	
  ...
  "SMNSampleCN.MedianDepthPON_Rscript": "/mnt/raw-data/scripts/wdls/tasks/MedianDepthPON.R",
...
java -Dconfig.file=/home/credin/.cromwell_config.file -jar /mnt/raw-data/tools/cromwell/cromwell-86.jar run /mnt/raw-data/scripts/wdls/workflows/SMN-modules_WES.wdl -i ${WRKDIR}/json/${cohort_name}.SMNCNcalling.input.json -o ${WRKDIR}/json/${cohort_name}.SMNCNcalling.options.json
